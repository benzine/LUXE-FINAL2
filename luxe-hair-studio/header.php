...
<meta charset="UTF-8">
    ...
    <?php $luxe_img = get_template_directory_uri() . '/images'; ?>
    <link rel="preload" as="image" fetchpriority="high" href="<?php echo $luxe_img; ?>/img-0-_result.png">
    <link rel="preload" as="image" fetchpriority="high" href="<?php echo $luxe_img; ?>/img-1-_result.png">
...
<meta property="og:image" content="<?php echo $luxe_img; ?>/img-0-_result.png">
...
<meta name="twitter:image" content="<?php echo $luxe_img; ?>/img-0-_result.png">
<script type="application/ld+json">
      {
        ...
        "image": "<?php echo $luxe_img; ?>/img-0-_result.png",
        "priceRange": "£££",
